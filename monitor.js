...
async function processQuote(quote) {
  ...
  const priceOfMIWETH = fromAmount / convertedToAmount;
  const priceOfMIWETHDiv10 = priceOfMIWETH / 10;

  console.log(`🔹 To Amount Min (MIWETH): ${toAmountMin}`);
  console.log(`💰 Price of MIWETH: ${priceOfMIWETH.toFixed(6)} USDC`);
  console.log(`💲 Price of MIWETH / 10: ${priceOfMIWETHDiv10.toFixed(6)} USDC`);
  ...
  const message = `🚀 *ARBITRAGE AI RESULT FROM JUMPER USDC TO MIWETH* 🚀\n\n`
    ...
    + `💰 *Price of MIWETH:* ${priceOfMIWETH.toFixed(6)} USDC\n`
    + `💲 *Price of MIWETH / 10:* ${priceOfMIWETHDiv10.toFixed(6)} USDC\n`
